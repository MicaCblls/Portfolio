...
const NavBar = () => {
  return (
    <>
      <nav className="w-full hidden md:flex justify-center items-center h-auto">
        <div
          className="flex flex-row justify-center items-center top-0 w-2/4 h-16 outline-offset-4 py-4 px-5 "
