...
const titleRef = useRef(null);
  ...
  return (
    <section id="home" className="flex flex-col w-full h-auto justify-start items-center  ease-in-out duration-300 dark:border-b dark:border-stone-600 bg-white dark:bg-darkNeutral px-4 md:px-14 pb-4">
      <div className="flex flex-col text-center items-center justify-center animate-fadeIn animation-delay-2 my-10 py-16 sm:py-32 md:py-48 md:flex-row md:space-x-2 md:text-left">
        ...
        className="text-darkPink text-4xl font-bold mt-6 md:mt-0 md:text-7xl">Hi, I&#39;m Micaela V. Ceballos!
          </h1>
          <p className="text-lg mt-4 mb-6 md:text-2xl">
            ...
            based in Buenos Aires, Argentina. Working towards creating software that
